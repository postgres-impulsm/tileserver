...
class TileServer(object):
    ...
    def handle_request(self, request):
        ...
        tile_data = first_cache.read_first_cache(self.first_cache_dir, cache_path_list)
        ...
        elif first_cache.roll_the_dice(self.first_cache_refresh_prob):
            with self._lock:
...
def create_tileserver_from_config(config):
    ...
    assert isinstance(first_cache_refresh_prob, (int, long))
